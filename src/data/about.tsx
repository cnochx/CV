import {AcademicCapIcon,
        CalendarIcon,
        FlagIcon,
        SparklesIcon} from '@heroicons/react/20/solid';
import {BuildingOffice2Icon, MapIcon} from '@heroicons/react/24/outline';
import profile from 'public/images/martin_grellmann.jpg';
...
export const aboutData: about = {
  ...
  aboutItems: [
     ...
     {label: 'Certifications',
      text: 'Scrum Master PSMI, Full-Stack Web Developer certification',
      Icon: AcademicCapIcon},
     {label: 'Methods',
