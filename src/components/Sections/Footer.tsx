...
const Footer: FC = memo(() => (
  <div className="relative bg-neutral-900 px-4 pb-6 pt-12 sm:px-16 sm:pb-8 sm:pt-14">
    ...
    <div className="flex flex-col items-center gap-y-6">
      ...
      <div className="flex flex-col items-center gap-y-6">
        <h3><strong className="text-stone-100">Imprint</strong></h3>
        ...
        <span className="text-sm text-neutral-700">{currentYear}, written by Martin Grellmann</span>
      </div>
    </div>
    ));
